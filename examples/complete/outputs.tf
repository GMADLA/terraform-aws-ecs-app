...
output "ecr_registry_id" {
  value       = module.ecs_app.ecr_registry_id
...
output "ecr_repository_name" {
  value       = module.ecs_app.ecr_repository_name
...
output "ecs_service_role_arn" {
  ...
  value       = module.ecs_app.ecs_service_role_arn
}

output "ecs_task_exec_role_name" {
  description = "ECS Task role name"
  value       = module.ecs_app.ecs_task_exec_role_name
}

output "ecs_task_exec_role_arn" {
  description = "ECS Task exec role ARN"
  value       = module.ecs_app.ecs_task_exec_role_arn
}

output "ecs_task_role_name" {
  description = "ECS Task role name"
  value       = module.ecs_app.ecs_task_role_name
}
...
output "ecs_task_role_id" {
  ...
  value       = module.ecs_app.ecs_task_role_id
}

output "ecs_service_security_group_id" {
  description = "Security Group ID of the ECS task"
  value       = module.ecs_app.ecs_service_security_group_id
}

output "ecs_task_definition_family" {
  description = "ECS task definition family"
  value       = module.ecs_app.ecs_task_definition_family
}

output "ecs_task_definition_revision" {
  description = "ECS task definition revision"
  value       = module.ecs_app.ecs_task_definition_revision
}

output "codebuild_project_name" {
  description = "CodeBuild project name"
  value       = module.ecs_app.codebuild_project_name
}

output "codebuild_project_id" {
  description = "CodeBuild project ID"
  value       = module.ecs_app.codebuild_project_id
}

output "codebuild_role_id" {
  description = "CodeBuild IAM Role ID"
  value       = module.ecs_app.codebuild_role_id
}

output "codebuild_role_arn" {
  description = "CodeBuild IAM Role ARN"
  value       = module.ecs_app.codebuild_role_arn
}

output "codebuild_cache_bucket_name" {
  description = "CodeBuild cache S3 bucket name"
  value       = module.ecs_app.codebuild_cache_bucket_name
}

output "codebuild_cache_bucket_arn" {
  description = "CodeBuild cache S3 bucket ARN"
  value       = module.ecs_app.codebuild_cache_bucket_arn
}

output "codebuild_badge_url" {
  description = "The URL of the build badge when badge_enabled is enabled"
  value       = module.ecs_app.codebuild_badge_url
}

output "codepipeline_id" {
  description = "CodePipeline ID"
  value       = module.ecs_app.codepipeline_id
}

output "codepipeline_arn" {
  description = "CodePipeline ARN"
  value       = module.ecs_app.codepipeline_arn
}

output "codepipeline_webhook_id" {
  description = "The CodePipeline webhook's ID"
  value       = module.ecs_app.codepipeline_webhook_id
}
...
output "codepipeline_webhook_url" {
  ...
  value       = module.ecs_app.codepipeline_webhook_url
  sensitive   = true
}

output "ecs_cloudwatch_autoscaling_scale_up_policy_arn" {
  description = "ARN of the scale up policy"
  value       = module.ecs_app.ecs_cloudwatch_autoscaling_scale_up_policy_arn
}

output "ecs_cloudwatch_autoscaling_scale_down_policy_arn" {
  description = "ARN of the scale down policy"
  value       = module.ecs_app.ecs_cloudwatch_autoscaling_scale_down_policy_arn
}

output "ecs_alarms_cpu_utilization_high_cloudwatch_metric_alarm_id" {
  value       = module.ecs_app.ecs_alarms_cpu_utilization_high_cloudwatch_metric_alarm_id
...
output "ecs_alarms_cpu_utilization_high_cloudwatch_metric_alarm_arn" {
  value       = module.ecs_app.ecs_alarms_cpu_utilization_high_cloudwatch_metric_alarm_arn
...
output "ecs_alarms_cpu_utilization_low_cloudwatch_metric_alarm_id" {
  value       = module.ecs_app.ecs_alarms_cpu_utilization_low_cloudwatch_metric_alarm_id
...
output "ecs_alarms_cpu_utilization_low_cloudwatch_metric_alarm_arn" {
  value       = module.ecs_app.ecs_alarms_cpu_utilization_low_cloudwatch_metric_alarm_arn
...
output "ecs_alarms_memory_utilization_high_cloudwatch_metric_alarm_id" {
  value       = module.ecs_app.ecs_alarms_memory_utilization_high_cloudwatch_metric_alarm_id
...
output "ecs_alarms_memory_utilization_high_cloudwatch_metric_alarm_arn" {
  value       = module.ecs_app.ecs_alarms_memory_utilization_high_cloudwatch_metric_alarm_arn
...
output "ecs_alarms_memory_utilization_low_cloudwatch_metric_alarm_id" {
  value       = module.ecs_app.ecs_alarms_memory_utilization_low_cloudwatch_metric_alarm_id
...
output "ecs_alarms_memory_utilization_low_cloudwatch_metric_alarm_arn" {
  value       = module.ecs_app.ecs_alarms_memory_utilization_low_cloudwatch_metric_alarm_arn
...
output "httpcode_target_3xx_count_cloudwatch_metric_alarm_id" {
  value       = module.ecs_app.httpcode_target_3xx_count_cloudwatch_metric_alarm_id
...
output "httpcode_target_3xx_count_cloudwatch_metric_alarm_arn" {
  value       = module.ecs_app.httpcode_target_3xx_count_cloudwatch_metric_alarm_arn
...
output "httpcode_target_4xx_count_cloudwatch_metric_alarm_id" {
  value       = module.ecs_app.httpcode_target_4xx_count_cloudwatch_metric_alarm_id
...
output "httpcode_target_4xx_count_cloudwatch_metric_alarm_arn" {
  value       = module.ecs_app.httpcode_target_4xx_count_cloudwatch_metric_alarm_arn
...
output "httpcode_target_5xx_count_cloudwatch_metric_alarm_id" {
  value       = module.ecs_app.httpcode_target_5xx_count_cloudwatch_metric_alarm_id
...
output "httpcode_target_5xx_count_cloudwatch_metric_alarm_arn" {
  value       = module.ecs_app.httpcode_target_5xx_count_cloudwatch_metric_alarm_arn
...
output "target_response_time_average_cloudwatch_metric_alarm_arn" {
  value       = module.ecs_app.target_response_time_average_cloudwatch_metric_alarm_arn
